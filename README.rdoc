...
h2. Example usage:
  ...
  # drop-in replacement for mysqldump
    ...
    # just like script/dbconsole < some/path.sql
...
Allow specifying records to update, when loading without schema.

Ability to parse a git diff into the above.
